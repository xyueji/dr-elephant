 ...
 */
public class TezScopeSpeedHeuristic implements Heuristic<TezApplicationData> {
  ...
  public TezScopeSpeedHeuristic(HeuristicConfigurationData heuristicConfData) {
  ...
  public HeuristicResult apply(TezApplicationData data) {
    ...
    TezTaskData[] tasks = data.getScopeTasks();
